...
<p>
Working towards an understanding of the evolutionary underpinnings of natural product biosynthesis has two major consequences.  First, it offers a rational prioritization framework for isolation of strains enriched in novel biosynthetic potential. Second, it leads to testable hypotheses about the natural roles of natural products.  Uncovering the role these molecules play in mediating ecological and evolutionarily-derived interations will offer huge insights for optimizing natural product drug discovery.
</p>
<p>
...
<figcaption><font size="3">Photo: Klassen, J. L. (2014). Microbial secondary metabolites and their impacts on insect symbioses. Current Opinion in Insect Science, 4, 15–22. http://doi.org/10.1016/j.cois.2014.08.004</font></figcaption>
</figure>
</center>
<p>
