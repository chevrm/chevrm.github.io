...
<p>
Given these bacteria appear to be a) highly prolific in secondary metabolite capability, b) highly variable in their biosynthetic gene cluster content from ant colony to colony, and c) their genomes show much evidence of horizontal transfer of secondary metaoblite gene clusters suggest that not only can these actinomycetes provide anti-biotic and anti-fungal protection of the ant's cultivar, they may be a prolific discovery avenue for compounds of human therapeutic and biotechnological use.  In a collaboration with the <a href='https://clardy.med.harvard.edu/'>Clardy Lab</a> at Harvard we hope to do just that.
</p>
<p>
