...
<p>
These bacteria appear to be a) highly prolific in secondary metabolite capability, b) highly variable in their biosynthetic gene cluster content from ant colony to colony, and c) their genomes show much evidence of horizontal transfer of secondary metaoblite gene clusters.  Our hypothesis is that not only can these actinomycetes provide anti-biotic and anti-fungal protection of the ant's cultivar, they may be a prolific discovery avenue for compounds of human therapeutic and biotechnological use.  The likelihood of a gene cluster under high selective pressure to be medically important is quite high when you consider that millions of years of selective evolution are on our side.
</p>
<p>
Nature is spending a lot of energy to make the molecules, so it follows that they must be making them for a reason...and in a collaboration with the <a href='https://clardy.med.harvard.edu/'>Clardy Lab</a> at Harvard we hope to prove exactly that.
</p>
<p>
You can find me on <a href='http://twitter.com/wildtypeMC'>twitter</a> and <a href='http://www.linkedin.com/in/chevrette'>linkedin</a>.  I have a sporadically active <a href='https://github.com/chevrm'>github</a> account, but typically you'll have to ask me for my code. Dont't be shy.  Feel free to contact me at chevrm (at) gmail (dot) com!
</p>
'''}
