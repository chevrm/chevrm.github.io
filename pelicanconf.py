...
Bacteria, especially actinomycetes, have a reputation for biosynthesizing chemicals that are of clinical or biotechnological use.  Over half of the drugs approved by the FDA in the past decade are of natural origin; many more are synthetically derived from natural scaffolds.  I get my kicks from a) computationally mining genome data from these bacteria to find biosynthetic gene clusters (and predict their products), b) understanding the regulation of these compounds (e.g. figuring out how to turn them to actually make the molecule), and c) developing methods for engineering the gene content of these clusters to generate new and exciting compounds.
</p>
<p>
