...
'''
<p>
I search for drugs. Bacteria, especially actinomycetes, have a reputation for biosynthesizing chemicals that are of clinical or biotechnological use.  Over half of the antibiotics approved by the FDA in the past decade are of natural origin; many more are synthetically derived from natural scaffolds.  I get my kicks from a) computationally mining genome data from these bacteria to find biosynthetic gene clusters (and predict their products)  b) understanding the regulation of these compunds (e.g. figuring out how to turn them on)  and c) developing methods for engineering the gene content of these clusters to generate new and exciting compunds.
</p>
<p>
Currently, I am the Head of Experimental Genomics at Warp Drive Bio, which has built the most massive bacterial genome database in history.  I will be joining UW-Madison in 08/2015 as a member of Cameron Currie's lab to continue my research on secondary metabolites and their role in nature.  I will be taking an evolutionary approach to pose key questions surrounding polyketide and non-ribosomal peptide gene cluster diversity.
</p>
<p>
